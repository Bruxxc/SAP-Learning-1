sap.ui.define(["sap/base/i18n/ResourceBundle"], function (ResourceBundle) {
    ...
    return {
      ...
      iconForCancellation: function (sCancelled) {
        return sCancelled === "X" ? "sap-icon://cancel" : "sap-icon://accept";
      },
  
      tooltipForCancellation: function (sCancelled) {
        return sCancelled === "X" ? "cancelled" : "not cancelled";
      }
